...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            InlineKeyboardButton('📥 ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴏᴠɪᴇs 📥', url=f'https://t.me/S_MovieChannel/875')
        ],[
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url=f'https://t.me/{SUPPORT_CHAT}'),
            InlineKeyboardButton('ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ', url=GRP_LNK)
        ],[
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            await asyncio.sleep(1) 
        await sts.delete()
        k = await client.send_message(chat_id = message.from_user.id, text=f"⚡ғɪʟᴇ sᴇɴᴅɪɴɢ ʙʏ:- 🆂︎🅷︎🆄︎🆅︎🅾︎")
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply(text=f"⚡ғɪʟᴇ sᴇɴᴅɪɴɢ ʙʏ:- 🆂︎🅷︎🆄︎🆅︎🅾︎")
            await asyncio.sleep(86400)
            await msg.delete()
