...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002205837203, -1002204400284').split()]  # For Multiple Id Use One Space Between Each.
