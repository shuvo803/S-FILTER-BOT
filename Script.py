...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """আমি {} সম্পর্কিত কিছু আমার ডাটাবেইজ এ খুঁজে পাইনি,😥 
আপনি গুগল থেকে চেক করে দেখেন আপনি যেই নামটি লিখেছেন সেটা সঠিক কি না | যদি সঠিক হয় তাহলে অপেক্ষা করেন অথবা মুভি রিকুয়েষ্ট গ্রুপে মুভি টির জন্য রিকুয়েষ্ট করেন |
আপনি কি এর মধ্যে কোনটির কথা বলছেন?👇

ɪ ᴄᴏᴜʟᴅɴ'ᴛ ғɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {} ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ,😥 ʏᴏᴜ ᴄᴀɴ ᴄʜᴇᴄᴋ ᴏɴ ɢᴏᴏɢʟᴇ ᴡʜᴇᴛʜᴇʀ ᴛʜᴇ ɴᴀᴍᴇ ʏᴏᴜ ᴡʀᴏᴛᴇ ɪs ᴄᴏʀʀᴇᴄᴛ ᴏʀ ɴᴏᴛ. ɪғ ɪᴛ ɪs ᴄᴏʀʀᴇᴄᴛ ᴛʜᴇɴ ᴡᴀɪᴛ ᴏʀ ʀᴇǫᴜᴇsᴛ ᴛʜᴇ ᴍᴏᴠɪᴇ ɪɴ ᴛʜᴇ ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ. 
ᴡʜɪᴄʜ ᴏɴᴇ ᴏғ ᴛʜᴇsᴇ ᴀʀᴇ ʏᴏᴜ ᴛᴀʟᴋɪɴɢ ᴀʙᴏᴜᴛ?👇

<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ](buttonurl:https://t.me/movie_group_02)</code>"""
