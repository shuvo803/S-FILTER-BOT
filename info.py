...
PICS = (environ.get('PICS', 'https://i.ibb.co.com/hx5w34VB/IMG-20250309-183942-350.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6509218702').split()] # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002277231245') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002574207034')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002621395764').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ShuvoBot:ShuvoBot@cluster0.mdhwz.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://STRenameBot:STRenameBot@cluster0.p7bubb0.mongodb.net/?retryWrites=true&w=majority")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://STRenameBot:STRenameBot@cluster0.p7bubb0.mongodb.net/?retryWrites=true&w=majority")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://STRenameBot:STRenameBot@cluster0.p7bubb0.mongodb.net/?retryWrites=true&w=majority")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.ibb.co.com/x86GTd17/IMG-20250325-143554-714.jpg') # payment code picture url.
...
SHORTLINK_API = environ.get('SHORTLINK_API', '67564248fa5c25a8a2f7d3a85a0aec068feef56a')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/S_MovieChannel/314') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
LANGUAGES = ["bengali", "ben", "malayalam", "mal", "tamil", "tam" ,"english", "eng", "hindi", "hin", "telugu", "tel", "kannada", "kan"]
